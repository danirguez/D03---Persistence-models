...
public class Authority implements GrantedAuthority {
	...
	@NotBlank
	@Pattern(regexp = "^" + Authority.ADMIN + "|" + Authority.USER + "|" + Authority.RANGER + "|" + Authority.SPONSOR + "|" + Authority.MANAGER + "|" + Authority.AUDITOR + "|"+ Authority.EXPLORER + "|" +  "|"+ Authority.CUSTOMER + "|" + "$")
	@Override
